...
public class WelcomeViewController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Bogatyrs.getMainStage().setTitle(resources.getString("welcome.title"));
    ...
    void continueBtnClicked(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(this.getClass().getResource("ProblemView.fxml"), langBundle);
        BorderPane pane;
        Scene scene;
